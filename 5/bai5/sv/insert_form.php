...
<head>
  ...
  <script language=JavaScript>
    function checkInput() {
      const fields = [
        'MaSV', 'Username', 'Password', 'HoSV', 'TenSV', 'GioiTinh', 'NgaySinh',
...
<body>
  <table>
    <form name="frmPHP" method="post" action="insert_action.php" onsubmit="return checkInput();">
      ...
      <tr>
        <td align="left">HoSV:</td>
        <td align="left">
          <input type="text" name="HoSV" size="25" maxlength="50" class="textbox">
        </td>
      </tr>

      <tr>
        <td align="left">TenSV:</td>
        <td align="left">
          <input type="text" name="TenSV" size="25" maxlength="50" class="textbox">
        </td>
      </tr>
      ...
      <tr>
        <td align="left">MaKH:</td>
        <td align="left">
          <input type="text" name="MaKH" size="25" maxlength="50" class="textbox">
        </td>
      </tr>

      <tr>
        <td align="left">HocBong:</td>
        <td align="left">
          <input type="text" name="HocBong" size="25" maxlength="50" class="textbox">
        </td>
      </tr>
