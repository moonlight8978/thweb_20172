...
<body>
  <table>
    <form name="frmPHP" method="post" action="insert_action.php" onsubmit="return checkInput();">
      ...
      <tr>
        <td align="left" >Maky:</td>
        <td align="left">
          <input type="text" name="Maky" size="25" maxlength="50" class="textbox">
        </td>
      </tr>

      <tr>
        <td align="left" >Malop:</td>
        <td align="left">
          <input type="text" name="Malop" size="25" maxlength="50" class="textbox">
        </td>
      </tr>

      <tr>
        <td align="left" >Sosv:</td>
        <td align="left">
          <input type="text" name="Sosv" size="25" maxlength="50" class="textbox">
        </td>
      </tr>
